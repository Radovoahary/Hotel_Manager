                ...
                <div className="bg-white p-6 shadow sm:rounded-lg">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                        ...
                        <button 
                            type="submit" 
                            disabled={processing} 
                            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded shadow-sm transition duration-150"
                        >
                ...
                <div className="bg-white p-6 shadow sm:rounded-lg">
                    ...
                    {rooms.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            {rooms.map((room) => (
                                <div key={room.id} className="border border-gray-200 rounded-lg p-5 shadow-sm bg-gray-50">
